...
void RegisterSprites(void) {
	sprites.balloonInflatingRed = AERSpriteRegister(
			"BalloonInflatingRed",
			"sprites/balloon/red_inflating.png",
			6,
			6,
			40
	);
	sprites.balloonInflatingBlue = AERSpriteRegister(
			"BalloonInflatingBlue",
			"sprites/balloon/blue_inflating.png",
			6,
			6,
			40
	);
	sprites.balloonInflatedRed = AERSpriteRegister(
			"BalloonInflatedRed",
			"sprites/balloon/red_inflated.png",
			6,
			6,
			40
	);
	sprites.balloonInflatedBlue = AERSpriteRegister(
			"BalloonInflatedBlue",
			"sprites/balloon/blue_inflated.png",
			6,
			6,
			40
	);
	sprites.balloonInflatedSolidMask = AERSpriteRegister(
			"BalloonInflatedSolidMask",
			"sprites/balloon/inflated_solid_mask.png",
			1,
			6,
			2
	);
	...
	sprites.balloonDyingBlue = AERSpriteRegister(
			"BalloonDyingBlue",
			"sprites/balloon/blue_dying.png",
			3,
			6,
			40
	);
	sprites.balloonCarcassRed = AERSpriteRegister(
			"BalloonCarcassRed",
			"sprites/balloon/red_carcass.png",
			1,
			6,
			2
	);
	sprites.balloonCarcassBlue = AERSpriteRegister(
			"BalloonCarcassBlue",
			"sprites/balloon/blue_carcass.png",
			1,
			6,
			2
	);
